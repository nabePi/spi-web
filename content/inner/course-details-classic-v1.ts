...
export const courseDetailsClassicV1Content: CourseDetailsContent = {
  ...
  overviewParagraphs: [
    ...
    "Kajian disusun secara terencana dan terukur, bukan sebagai rangkaian ceramah lepas. Materinya bergerak dari fondasi — konsep adab dan pandangan dunia Islam — menuju tradisi filsafat dan tasawuf, lalu ke isu-isu kontemporer. Seluruh program diselenggarakan tanpa biaya.",
  ],
  highlightsTitle: "Poin utama",
  highlights: [
    "Gratis — tanpa biaya pendaftaran maupun biaya kelas",
